...
import SavedCard from '../_components/saved/SavedCard'
...
const SavedCoffeeShop = () => {
  return (
    <div className='grid lg:grid-cols-4 sm:grid-cols-2 gap-y-8 px-20 mt-10'>
      {data.map((shop : CoffeeShop) => <SavedCard coffeeShop={shop} />)}
    </div>
  )
}
